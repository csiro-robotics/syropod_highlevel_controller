# Syropod Parameter File (config/*syropod_name*.yaml) 
...
### /hexapod/parameters/start_up_sequence:
    Determines if hexapod attempts unpacking/packing & startup/shutdown procedures. If false the hexapod will move 
...
# Gait Parameters File (config/gait.yaml):
