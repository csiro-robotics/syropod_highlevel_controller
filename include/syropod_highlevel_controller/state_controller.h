...
public:
   ...
   */
  void primaryTipPositionPublisher();
...
private:
  ...
  ros::Publisher primary_leg_current_position_publisher_;   ///< Subscriber for topic "/syropod_remote/primary_currrent_tip_position"
  ros::Publisher secondary_leg_current_position_publisher_; ///< Subscriber for topic "/syropod_remote/secondary_currrent_tip_position"
